...
func (e OrderEdges) LaunchesOrErr() ([]*Launch, error) {
	if e.loadedTypes[0] {
...
// QueryLaunches queries the "launches" edge of the Order entity.
func (o *Order) QueryLaunches() *LaunchQuery {
	return (&OrderClient{config: o.config}).QueryLaunches(o)
}
