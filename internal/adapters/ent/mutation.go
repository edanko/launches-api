...
func (m *LaunchMutation) SetFiles(s []string) {
	m.files = &s
}

// Files returns the value of the "files" field in the mutation.
func (m *LaunchMutation) Files() (r []string, exists bool) {
	v := m.files
	if v == nil {
		return
	}
...
// OldFiles returns the old "files" field's value of the Launch entity.
// If the Launch object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *LaunchMutation) OldFiles(ctx context.Context) (v []string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *LaunchMutation) ClearFiles() {
	m.files = nil
	m.clearedFields[launch.FieldFiles] = struct{}{}
}

// FilesCleared returns if the "files" field was cleared in this mutation.
func (m *LaunchMutation) FilesCleared() bool {
	_, ok := m.clearedFields[launch.FieldFiles]
	return ok
}

// ResetFiles resets all changes to the "files" field.
func (m *LaunchMutation) ResetFiles() {
	m.files = nil
	delete(m.clearedFields, launch.FieldFiles)
}
...
func (m *LaunchMutation) Fields() []string {
	...
	if m.files != nil {
		fields = append(fields, launch.FieldFiles)
	}
	if m.applicant != nil {
...
func (m *LaunchMutation) ClearedFields() []string {
	...
	if m.FieldCleared(launch.FieldFiles) {
		fields = append(fields, launch.FieldFiles)
	}
	return fields
}
