...
func (g GrpcServer) GetKind(
	...
	appKind, err := g.app.Queries.GetKind.Handle(ctx, queries2.GetKindRequest{
		ID: id,
	})
	if err != nil {
		return nil, status.Error(codes.Internal, err.Error())
...
func (g GrpcServer) GetKindByName(
	...
	appKind, err := g.app.Queries.GetKindByName.Handle(ctx, queries2.GetKindByNameRequest{
...
func (g GrpcServer) ChangeKindDescription(
	...
	err = g.app.CommandBus.Send(ctx, commands2.ChangeKindDescription{
		ID:          id,
...
func (g GrpcServer) ChangeKindName(
	...
	err = g.app.CommandBus.Send(ctx, commands2.ChangeKindName{
		ID:   id,
		Name: request.Name,
	})
...
func (g GrpcServer) CreateKind(
	...
	err := g.app.CommandBus.Send(ctx, commands2.CreateKind{
		ID:          uuid.New(),
		Name:        request.Name,
		Description: request.Description,
		Status:      statusQuery,
...
func (g GrpcServer) DeleteKind(
	...
	err = g.app.CommandBus.Send(ctx, commands2.DeleteKind{
		ID: id,
	})
...
func (g GrpcServer) MakeKindDraft(
	...
	err = g.app.CommandBus.Send(ctx, commands2.MakeKindDraft{
		ID: id,
	})
...
func (g GrpcServer) MakeKindPublished(
	...
	err = g.app.CommandBus.Send(ctx, commands2.MakeKindPublished{
		ID: id,
	})
